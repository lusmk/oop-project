...
public class ProgrammingForDataScience extends Course{
    private static int questionsAnswered = 0;

    public ProgrammingForDataScience() {
        super(Student.Major.DATA_SCIENCE, 3,
                "codeFiles/src/TextFiles/programmingfordatascience.txt");
    }
